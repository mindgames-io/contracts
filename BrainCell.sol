...
contract BrainCell is ERC20, Ownable, Authorizable {
    ...
    function delegateBySig(
        ...
        require(
            signatory != address(0),
            "BrainCell::delegateBySig: invalid signature"
        );
        require(
            nonce == nonces[signatory]++,
            "BrainCell::delegateBySig: invalid nonce"
        );
        require(now <= expiry, "BrainCell::delegateBySig: signature expired");
        ...
        returns (uint256)
    {
        require(
            ...
            "BrainCell::getPriorVotes: not yet determined"
        );
    ...
    function _writeCheckpoint(
        ...
        uint32 blockNumber =
            safe32(
                block.number,
                "BrainCell::_writeCheckpoint: block number exceeds 32 bits"
            );
